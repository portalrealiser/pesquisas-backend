...
// O Postgres devolve BIGINT (int8) como string por padrão (pra não perder precisão).
// Na nossa escala os IDs cabem com folga num número JS, então convertemos pra Number —
// isso evita bugs de comparação (id string vs id número) nas rotas.
